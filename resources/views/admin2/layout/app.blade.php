                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li><a href="{{ route('deposit.admin') }}">Deposits</a></li>
                            <li><a href="{{ route('withdraw.admin') }}">Withdrawals</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li><a href="{{ route('investment-plans.create') }}">Add Package</a></li>
                            <li><a href="{{ route('investment-plans.index') }}">All Packages</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="{{ route('manage-users') }}" class="waves-effect waves-light">
                            <i class="mdi mdi-account-supervisor"></i>
                            <span> Users </span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('ref.index') }}" class="waves-effect waves-light">
                            <i class="mdi mdi-account-supervisor"></i>
                            <span> Referrals </span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('setting.create') }}" class="waves-effect waves-light">
