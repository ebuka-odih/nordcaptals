                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach($user_deposit->deposits as $deposit)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('single_deposit.view', $deposit->id) }}" class="btn btn-secondary btn-sm">View</a>
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                            @if($deposit->status == 'pending')
                                                                <a class="dropdown-item" href="{{ route('approve_deposit', $deposit) }}">Approve</a>
                                                            @else
{{--                                                                <a class="dropdown-item" href="{{ route('admin.decline_deposit', $deposit) }}">Decline</a>--}}
                                                            @endif
                                                        </div>
