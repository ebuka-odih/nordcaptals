                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">User / <strong class="text-primary small">{{ $user_withdraw->last_name .' '. $user_withdraw->first_name }}</strong></h3>
                                            <h3 class="nk-block-title page-title">Account Balance: <strong class="text-primary small"> {{ $user_withdraw->acct_wallet }}</strong></h3>
                                        ...
                                        <div class="card-aside-wrap">
                                            <div class="card-content">
                                                <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('show-user', $user_withdraw->id)}}"><em class="icon ni ni-user-circle"></em><span>Personal</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('user_withdraw.show', $user_withdraw->id) }}"><em class="icon ni ni-repeat"></em><span>Withdrawals</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('user_deposit.show', $user_withdraw->id) }}"><em class="icon ni ni-activity"></em><span>Deposit</span></a>
                                                    </li>
                                                        ...
                                                        <div class="nk-content-inner">
                                                            <div class="nk-content-body">
                                                                <div class="nk-block-head nk-block-head-sm">
                                                                    <div class="nk-block-between g-3">
                                                                        <div class="nk-block-head-content">
                                                                            <h3 class="nk-block-title page-title">Withdraw History</h3>
                                                                                    ...
                                                                                    <table class="datatable-init nk-tb-list nk-tb-ulist table-stripped" data-auto-responsive="false">
                                                                                        ...
                                                                                        @foreach($user_withdraw->withdraws as $withdraw)
                                                                                            <tr class="nk-tb-item">
                                                                                                ...
                                                                                                <td class="nk-tb-col tb-col-mb">
                                                                                                    <div class="nk-tb-col text-right">
                                                                                                        <span class="tb-amount">({{ $withdraw->code_hash }})</span>
                                                                                                    </div>
                                                                                                </td>
                                                                                                <td class="nk-tb-col ">
