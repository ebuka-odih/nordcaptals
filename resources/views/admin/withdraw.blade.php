        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Withdrawal Transactions</h3>
                                        ...
                                        <div class="nk-tb-col">
                                            <div class="nk-tnx-type">
                                                ...
                                                <div class="nk-tnx-type-text">
                                                    ...
                                                    <span class="tb-amount mt-1 mb-1">{{ date('d-M-y', strtotime($withdraw->created_at)) }}</span>
                                    ...
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-avatar bg-dark d-none d-sm-flex">
                                                ...
                                                <span>{{ optional($withdraw->users)->last_name[0] .' '. optional($withdraw->users)->first_name[0]   }}</span>
                                            </div>
                                            <div class="user-info">
                                                <span class="tb-lead">{{ optional($withdraw->users)->last_name }} {{ optional($withdraw->users)->first_name }}<span class="d-md-none ml-1"></span></span>

                                                <span>{{ optional($withdraw->users)->email }}</span>
                                            </div>
                                        </div>
                                    </td>
